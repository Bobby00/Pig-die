...
function Player(playerName, turnScore, diceRolls, totalScore, active) {
...
function activeUser() {
    if (player1.active === true && player2.active === false) {
        $('.sidePlayer1').children().prop('disabled', false);
        $('.sidePlayer1').removeClass('disableGamingArea');
        $('.sidePlayer2').children().prop('disabled', true);
        $('.sidePlayer2').addClass('disableGamingArea');
    } else {
        $('.sidePlayer1').children().prop('disabled', true);
        $('.sidePlayer1').addClass('disableGamingArea');
        $('.sidePlayer2').children().prop('disabled', false);
        $('.sidePlayer2').removeClass('disableGamingArea');
    }
};
